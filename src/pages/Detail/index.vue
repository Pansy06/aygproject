          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(item,index) in spuSaleAttrList" :key="index">
                ...
                <dd changeprice="0" :class="{active:attrVal.isChecked==1}" @click="changeActive(attrVal,item.spuSaleAttrValueList)" v-for="(attrVal,index) in item.spuSaleAttrValueList" :key="index"> {{ attrVal.saleAttrValueName}}</dd>>
              </dl>
