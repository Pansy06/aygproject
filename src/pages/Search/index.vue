            ...
            <div class="navbar-inner filter">
              ...
              <ul class="sui-nav">
                <li :class="{active:isOne}" @click="changeOrder(1)">
                  <a href="#">综合<span v-show="isOne"><span v-show="isUp">⬆</span><span v-show="isDown">⬇</span></span></a>
                </li>
                <li :class="{active:isTwo}" @click="changeOrder(2)">
                  <a href="#">价格<span v-show="isTwo"><span v-show="isUp">⬆</span><span v-show="isDown">⬇</span></span></a>
                </li>
              </ul>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    attrInfo(item, value) {
      let prop = `${item.attrId}:${value}:${item.attrName}`;
